...
def main(args):
    ...
    if args.do_train:
        ...
        if args.dataset == "smp":
            ...
            logger.info("num:", text_data['train']['num'])
            logger.info("ood:", text_data['train']['ood'])
            logger.info("id:", text_data['train']['id'])
            logger.info("valid data:")
            logger.info("num:", text_data['val']['num'])
            logger.info("ood:", text_data['val']['ood'])
            logger.info("id:", text_data['val']['id'])
            logger.info("test data:")
            logger.info("num:", text_data['test']['num'])
            logger.info("ood:", text_data['test']['ood'])
            logger.info("id:", text_data['test']['id'])
