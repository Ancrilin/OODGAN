...
for seed in ${seeds} ; do
  ...
  --alpha=0.95  \
  --manual_knowledge  \
  --result=base-gan-oodp-alpha0.95_manual/base-gan-oodp-alpha0.95_manual \
  --output_dir=base-gan-oodp-alpha0.95_manual/base-gan-oodp-alpha0.95_manual-smp_${seed}
