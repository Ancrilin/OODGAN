...
for seed in ${seeds} ; do
  ...
  --alpha=0.90  \
  --manual_knowledge  \
  --result=base-gan-oodp-alpha0.90_manual/base-gan-oodp-alpha0.90_manual \
  --output_dir=base-gan-oodp-alpha0.90_manual/base-gan-oodp-alpha0.90_manual-smp_${seed}
