...
for seed in ${seeds} ; do
  ...
  --alpha=0.99  \
  --manual_knowledge  \
  --result=base-gan-oodp-alpha0.99_manual/base-gan-oodp-alpha0.99_manual \
  --output_dir=base-gan-oodp-alpha0.99_manual/base-gan-oodp-alpha0.99_manual-smp_${seed}
