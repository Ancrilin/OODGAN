...
for seed in ${seeds} ; do
  ...
  --alpha=0.85  \
  --manual_knowledge  \
  --result=base-gan-oodp-alpha0.85_manual/base-gan-oodp-alpha0.85_manual \
  --output_dir=base-gan-oodp-alpha0.85_manual/base-gan-oodp-alpha0.85_manual-smp_${seed}
