...
for seed in ${seeds} ; do
  ...
  --result=gan-oodp-alpha0.90-pseudo/gan-oodp-alpha0.90-pseudo${1}/gan-oodp-alpha0.90-pseudo${1} \
  --output_dir=gan-oodp-alpha0.90-pseudo/gan-oodp-alpha0.90-pseudo${1}/gan-oodp-alpha0.90-pseudo${1}-smp_${seed}
